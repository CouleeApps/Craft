...
//  block_types[block_count ++] = Block       = (BlockType){ w,   h, b, p, t, y                   };
    ...
    block_types[block_count ++] = Grass       = (BlockType){ 1, 1.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Sand        = (BlockType){ 2, 1.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Slab        = (BlockType){ 3, 3.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Brick       = (BlockType){ 4, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Wood        = (BlockType){ 5, 3.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Stone       = (BlockType){ 6, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Dirt        = (BlockType){ 7, 1.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Snow        = (BlockType){ 8, 1.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Glass       = (BlockType){ 9, 1.0, 1, 1, 1, BlockRenderTypeBlock};
    block_types[block_count ++] = Cobblestone = (BlockType){10, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = LightSlab   = (BlockType){11, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = DarkSlab    = (BlockType){12, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = WoodBox     = (BlockType){13, 2.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Head        = (BlockType){14, 0.0, 0, 0, 0, BlockRenderTypeNone };
    block_types[block_count ++] = Leaf        = (BlockType){15, 1.0, 1, 1, 1, BlockRenderTypeBlock};
