...
//  block_types[block_count ++] = Block       = (BlockType){ w,   h, b, p, t, y                   };
    ...
    block_types[block_count ++] = Snow        = (BlockType){ 9, 1.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = Glass       = (BlockType){10, 1.0, 1, 1, 1, BlockRenderTypeBlock};
    block_types[block_count ++] = Cobblestone = (BlockType){11, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = LightSlab   = (BlockType){12, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = DarkSlab    = (BlockType){13, 4.0, 1, 1, 0, BlockRenderTypeBlock};
    block_types[block_count ++] = WoodBox     = (BlockType){14, 2.0, 1, 1, 0, BlockRenderTypeBlock};
